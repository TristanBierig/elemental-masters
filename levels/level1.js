...
level1 = new Level(
    ...
    [
        ...
        new Background('img/Background/background/cloud.png', -2, -20, 720, 150),
        ...
        new Background('img/Background/background/cloud.png', 717, 50, 720, 150),
        ...
        new Background('img/Background/background/sky.png', 1434, 0),
        new Background('img/Background/background/cloud.png', 1434, 0, 720, 150),
        new Background('img/Background/background/mountain2.png', 1432, 150, 720, 200),
        new Background('img/Background/background/mountain.png', 1432, 80, 720, 400)
    ],
    [
